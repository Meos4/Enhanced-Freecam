...
namespace PS2::DBZInfiniteWorld
{
	...
	void Controller::update()
	{
		...
		ram.writeConditional(m_isButtonEnabled,
			offset.Fn_padStatus + 0x6C, 0xA623000E, 0xA620000E,
			offset.Fn_padStatus + 0x80, 0xA630000C, 0xA620000C
		);

		ram.writeConditional(m_isJoystickEnabled,
			offset.Fn_padStatus + 0xA4, 0xA2230018, 0xA2200018,
			offset.Fn_padStatus + 0xB0, 0xA2230019, 0xA2200019,
			offset.Fn_padStatus + 0xBC, 0xA223001A, 0xA220001A,
			offset.Fn_padStatus + 0xC8, 0xA223001B, 0xA220001B
		);
	}
